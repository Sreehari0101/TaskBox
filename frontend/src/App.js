...
class App extends Component {
  ...
  render() {
    return (
      <main className="content p-3 mb-2 custombg">
        <h1 className="text-white text-uppercase text-center my-4 heading">Task Box</h1>
        <div className="row ">
        ...
        <footer className ="my-3 mb-2 text-white text-center custombg">
